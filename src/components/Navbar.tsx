...
const Navbar = () => {
    ...
    return (
        ...
        lg:px-24 md:px-12 sm:px-6 px-4 fixed top-0"
        >
            <div className="flex items-center sm:gap-x-4 gap-x-2">
                <a href="#" className="md:text-2xl text-lg sm:text-xl">
                    Bryan Acuna
                </a>
                <i
                    ...
                    md:text-3xl sm:text-2xl text-xl text-gray-600 dark:text-gray-200 sm:ml-4 ml-2 cursor-pointer fa-solid fa-sun`}
                ></i>
            </div>
            <div>
                <a
                ...
                >
                    Contact
                    <span
                        className="absolute -bottom-1 left-0 w-full h-[1px] bg-gray-600 dark:bg-white transform scale-x-0 
